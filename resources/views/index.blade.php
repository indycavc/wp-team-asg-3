                        ...
                        @forelse ($mahasiswas as $mahasiswa)
                            <tr>
                                ...
                                <td>
                                    ...
                                    {{-- {{ route('mahasiswa-destroy', ['mahasiswa'=>$mahasiswa->id]) }} --}}
                                    <a href="/edit/{{ $mahasiswa->id }}" class="btn btn-warning">Edit</a>
                                    <a href="/delete/{{ $mahasiswa->id }}" class="btn btn-danger">Delete</a>
                                </td>
                            </tr>
                        @empty
